  ...
  for(int i = 0; i < listOfArtists() -> size(); i++)
    {
      ...
      html.append(_listOfDataObjects -> at(i) -> valueForStringAttribute("profile"));
      html.append(_listOfDataObjects -> at(i) -> valueForStringAttribute("real_name"));
      html.append(_listOfDataObjects -> at(i) -> valueForStringAttribute("num_images"));
